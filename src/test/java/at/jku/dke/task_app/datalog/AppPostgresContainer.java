package at.jku.dke.task_app.datalog;
...
class AppPostgresContainer extends PostgreSQLContainer<AppPostgresContainer> {
    ...
    public static final String USERNAME = "etutor_datalog_test_admin";
    public static final String PASSWORD = "strong-password";
    public static final String ETUTOR_USERNAME = "etutor_datalog_test";
    public static final String ETUTOR_PASSWORD = "etutor_datalog_pwd";
