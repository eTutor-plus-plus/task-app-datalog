...
class DatalogTaskControllerTest {
    ...
    void getShouldReturnOk() {
        given()
            ...
            // WHEN
            .when()
            .get("/api/task/dlg/{id}", this.taskId)
            // THEN
            .then()
    ...
    void getShouldReturnNotFound() {
        given()
            ...
            // WHEN
            .when()
            .get("/api/task/dlg/{id}", this.taskId + 1)
            // THEN
            .then()
            .log().ifValidationFails()
            .statusCode(404);
    ...
    void createShouldReturnCreated() {
        given()
            ...
            // WHEN
            .when()
            .post("/api/task/dlg/{id}", this.taskId + 2)
            // THEN
            .then()
            .log().ifValidationFails()
            .statusCode(201)
            .contentType(ContentType.JSON)
            .header("Location", containsString("/api/task/dlg/" + (this.taskId + 2)))
    ...
    void updateShouldReturnOk() {
        given()
            ...
            // WHEN
            .when()
            .put("/api/task/dlg/{id}", this.taskId)
            // THEN
            .then()
            .log().ifValidationFails()
            .statusCode(200)
    ...
    void updateShouldReturnNotFound() {
        given()
            ...
            // WHEN
            .when()
            .put("/api/task/dlg/{id}", this.taskId + 1)
            // THEN
            .then()
            .log().ifValidationFails()
            .statusCode(404);
    ...
    void deleteShouldReturnNoContent() {
        given()
            ...
            // WHEN
            .when()
            .delete("/api/task/dlg/{id}", this.taskId)
            // THEN
            .then()
            .log().ifValidationFails()
            .statusCode(204);
    ...
    void deleteShouldReturnNoContentOnNotFound() {
        given()
            ...
            // WHEN
            .when()
            .delete("/api/task/dlg/{id}", this.taskId + 1)
            // THEN
            .then()
            .log().ifValidationFails()
            .statusCode(204);
