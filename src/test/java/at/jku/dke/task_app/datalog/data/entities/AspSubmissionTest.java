...
class AspSubmissionTest {

    @Test
    void constructor1() {
        // Act
        var submission = new AspSubmission();
    ...
    void constructor2() {
        ...
        // Act
        var submission = new AspSubmission(expected);
    ...
    void constructor3() {
        ...
        // Act
        var submission = new AspSubmission(userId, assignmentId, task, language, feedbackLevel, mode, expected);
